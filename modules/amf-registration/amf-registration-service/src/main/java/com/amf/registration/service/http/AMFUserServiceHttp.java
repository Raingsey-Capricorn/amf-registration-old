...
public class AMFUserServiceHttp {
	...
	public static com.amf.registration.model.AMFUser addAMFUser(
			HttpPrincipal httpPrincipal, long groupId, String firstNameMap,
			String lastNameMap, String emailMap, String userNameMap,
			String genderMap, java.util.Date dateOfBirthMap, String passwordMap,
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, groupId, firstNameMap, lastNameMap, emailMap,
				userNameMap, genderMap, dateOfBirthMap, passwordMap,
	...
	private static final Class<?>[] _getAmfUserParameterTypes1 = new Class[] {
		long.class
	};
